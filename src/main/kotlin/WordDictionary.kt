...
fun main() {
    ...
    for (w in listOf("main.kotlin.WordDictionary", "addWord", "addWord", "search", "search", "search", "search", "search", "search")) {
        wd.addWord(w)
    }
...
/**
 * Your main.kotlin.WordDictionary object will be instantiated and called as such:
 * var obj = main.kotlin.WordDictionary()
 * obj.addWord(word)
